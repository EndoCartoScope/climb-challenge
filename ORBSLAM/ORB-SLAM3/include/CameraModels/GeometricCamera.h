...
namespace ORB_SLAM3 {
    ...
    public:
        ...
        virtual std::string getTypeColmapFormat() = 0;
        virtual std::string getParametersColmapFormat() = 0;
    ...
    public:
        std::string getImageSizeColmapFormat(){ return std::to_string(width) + " " + std::to_string(height);}
        void setImageSize(unsigned int width_, unsigned int height_) {width = width_; height = height_;}
    };
}
