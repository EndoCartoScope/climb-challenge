...
public:
    ...
    list<string> mlImageName;
    set<long unsigned int> msFrameIdToKF;
    set<long unsigned int> msFrameIdReloc;
    std::map<long unsigned int, string> mmFrameIdMerge;
    bool mbMergeDone;
    set<long unsigned int> msFrameIdLoop;
    bool mbLoopDone;
